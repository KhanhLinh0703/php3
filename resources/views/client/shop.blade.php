                        ...
                        <ul class="list-group">
                            @foreach ($categories as $category)
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    <a href="{{ route('shop', ['category_id' => $category->id, 'minPrice' => $minPrice, 'maxPrice' => $maxPrice]) }}"
            ...
            <div class="col-lg-9 col-md-12">
                <div class="row pb-3">
                            ...
                            <div class="dropdown ml-4">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="triggerId">
                                    <a class="dropdown-item"
                                        href="{{ route('shop', ['category_id' => $category_id, 'minPrice' => true]) }}">min
                                        Price</a>
                                    <a class="dropdown-item"
                                        href="{{ route('shop', ['category_id' => $category_id, 'maxPrice' => true]) }}">Max
                                        Price</a>
                                    <a class="dropdown-item" href="{{ route('shop') }}">New Product</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 pb-1 d-flex justify-content-center">
                        {{ $products->appends(['category_id' => $category->id])->links() }}
                    </div>
                </div>
            </div>
            <!-- Shop Product End -->
